...
function useTransition({
  ...
  const isInitialRef = (0, import_react2.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react2.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  return exited && !inProp ? null : (0, import_react2.cloneElement)(children, {
    ref: combinedRef
  });
}
...
//# sourceMappingURL=chunk-QF2UK6SO.js.map
